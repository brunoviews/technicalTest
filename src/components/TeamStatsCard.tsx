	...
	return (
		<div className="bg-white rounded-xl shadow p-4 flex flex-col items-center">
			...
			<img
				src={stats.team?.logo}
				alt={stats.team.name}
				className="w-14 h-14 rounded-full object-contain bg-white border mb-2"
			/>
			...
			<table className="w-full text-sm mb-2">
				<tbody>
					<tr>
						<td className="font-semibold">Played</td>
						<td
							className={
								otherStats
									? getStatColor(
											stats.fixtures.played?.total,
											otherStats.fixtures.played?.total,
											true,
										)
									: ''
							}
							...
							className={
								otherStats
									? getStatColor(
											...
											otherStats.fixtures.wins.total,
											true,
										)
									: ''
							}
					...
					<tr>
						<td className="font-semibold">Draws</td>
						<td
							className={
								otherStats
									? getStatColor(
											stats.fixtures.draws.total,
											otherStats.fixtures.draws.total,
											true,
										)
									: ''
							}
							...
							className={
								otherStats
									? getStatColor(
											...
											otherStats.fixtures.loses.total,
											false,
										)
									: ''
							}
					...
					<tr>
						<td className="font-semibold">Goals For</td>
						<td
							className={
								otherStats
									? getStatColor(
											stats.goals.for.total.total,
											otherStats.goals.for.total.total,
											true,
										)
									: ''
							}
					...
					<tr>
						<td className="font-semibold">Goals Against</td>
						<td
							className={
								otherStats
									? getStatColor(
											stats.goals.against.total.total,
											otherStats.goals.against.total.total,
											false,
										)
									: ''
							}
					...
					<tr>
						<td className="font-semibold">Clean Sheets</td>
						<td
							className={
								otherStats
									? getStatColor(
											stats.clean_sheet.total,
											otherStats.clean_sheet.total,
											true,
										)
									: ''
							}
